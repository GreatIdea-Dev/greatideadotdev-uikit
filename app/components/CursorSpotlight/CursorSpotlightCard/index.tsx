...
export default function CursorSpotlightCard({
  children,
  outerClasses,
  innerClasses,
}: {
  ...
  const outerCombinedClasses = 'mouseEffectOuterContainer' + ' ' + outerClasses;
  const innerCombinedClasses = 'mouseEffectInnerContainer' + ' ' + innerClasses;
  ...
  return (
    <div
      ...
      className={outerCombinedClasses}
    >
      <div className={innerCombinedClasses}>{children}</div>
    </div>
  );
}
